...
`dygyn-bet` is a Telegram Mini App MVP for fan predictions around the Dygyn Games.
...
5. User selects an event and one participant.
6. User assigns 1–100 virtual confidence points.
7. App shows vote counts, confidence totals, percentages, player history, and leaderboard.
