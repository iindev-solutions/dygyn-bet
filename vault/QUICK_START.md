...
- 100-point allocation voting works locally: one vote distributes exactly 100 points across 1–3 participants.
...
- Product mechanic implemented locally: one event vote = distribute exactly 100 virtual confidence points across 1–3 participants.
