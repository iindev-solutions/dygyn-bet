...
Важно: в MVP не использовать реальные деньги, коэффициенты, депозиты, выводы и “выигрыши”. Формулировка: **голосование / поддержка / рейтинг / очки**.
...
confidence_points: сумма 100, либо 33/33/33 при трёх участниках поровну
